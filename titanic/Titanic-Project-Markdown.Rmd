...
dir <- "/Users/Jeylan/Documents/Titanic-Project/"
setwd(dir)
...
## Model 5 has lowest AIC, 


train$fitted <- round(fitted(logmodel5, train), digit=0)

cbind(train, fitted = fitted(logmodel5))

train$fitted <- round(fitted(logmodel5), digit=0)
...
predictTest = predict(logmodel5, type = "response", newdata = test)
